...
public class StartButton extends JButton {
    ...
    public StartButton(String text, String rgbColor, boolean transparency, int x, int y, int width, int height) {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                StartButton.this.setForeground(new Color(4, 50, 200)); 
                //startButton.setBorderPainted(true);
            }
        
            @Override
            public void mouseExited(MouseEvent e) {
                StartButton.this.setForeground(new Color(1,50,150)); 
                StartButton.this.setBorderPainted(false);
            }
        });

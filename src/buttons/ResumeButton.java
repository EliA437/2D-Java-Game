...
public class ResumeButton extends JButton{
    public ResumeButton(String text, String rgbColor, boolean transparency, int x, int y, int width, int height) {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ResumeButton.this.setForeground(new Color(4, 50, 200)); 
                //exitButton.setBorderPainted(true);
            }
        
            @Override
            public void mouseExited(MouseEvent e) {
                ResumeButton.this.setForeground(new Color(1,50,150)); 
                ResumeButton.this.setBorderPainted(false);
            }
        });
